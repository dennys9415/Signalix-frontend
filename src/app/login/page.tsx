      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="space-y-2">
          <a
            ...
            className="flex items-center justify-center gap-3 w-full rounded-md border border-gray-700 bg-gray-800 hover:bg-gray-700 px-4 py-2 text-sm font-medium transition-colors"
          >
            <GoogleIcon />
